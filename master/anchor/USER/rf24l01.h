...
#define SPI_RF_CE_LOW()       GPIO_ResetBits(GPIOA, GPIO_Pin_3)
#define SPI_RF_CE_HIGH()      GPIO_SetBits(GPIOA, GPIO_Pin_3)
...
#define TX_PLOAD_WIDTH  19  //19字节有效数据宽度
#define RX_PLOAD_WIDTH  19  //19字节有效数据宽度
/*———————————————————————————————————————————————————————*/
