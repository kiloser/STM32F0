...
#define RF_IQR_PIN        GPIO_Pin_1
#define RF_IQR_PORT       GPIOB
#define RF_IQR_PIN_SCK    RCC_AHBPeriph_GPIOB
#define RF_IRQ_SOURCE			GPIO_PinSource11
...
#define SPI_RF_CS_LOW()       GPIO_ResetBits(RF_CS_PORT, RF_CS_PIN)
#define SPI_RF_CS_HIGH()      GPIO_SetBits(RF_CS_PORT, RF_CS_PIN)
#define SPI_RF_CE_LOW()       GPIO_ResetBits(RF_CS_PORT, RF_CE_PIN)
#define SPI_RF_CE_HIGH()      GPIO_SetBits(RF_CS_PORT, RF_CE_PIN)
#define SPI_RF_IRQ()		      GPIO_ReadInputDataBit ( RF_IQR_PORT, RF_IQR_PIN) //中断引脚
...
/*———————————————————————————————————————————————————————*/
extern uint8_t Tx_Buffer[33] ; // 无线传输发送数据
extern uint8_t Rx_Buffer[33] ; // 无线传输接收数据
